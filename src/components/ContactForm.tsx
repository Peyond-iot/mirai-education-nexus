      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Ready to start your journey? Get in touch with our expert team today.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Visit our office in Putalisadak, Kathmandu, or reach out to us through any of the following methods. Our team is here to help you achieve your educational goals.
              </p>
            </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        Kathmandu-30, Putalisadak, Nepal
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="student-visa">Student Visa Support</option>
                    <option value="ssw-visa">SSW Visa Counseling</option>
